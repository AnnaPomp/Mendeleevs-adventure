...
namespace GIGA.PixelCableRenderer.Editor
{
	...
	public class CableRendererEditor : UnityEditor.Editor
	{
		...
		private void DrawHandles(CableRenderer renderer)
		{
			...
			var fmh_294_69_638395532533791996 = Quaternion.identity; Vector3 newModifierPos = Handles.FreeMoveHandle(prevModifierPos, size, Vector3.zero, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
		...
		public static void DrawResizingHandles(CableRenderer renderer,bool hasDirection = false)
		{
			...
			var fmh_342_60_638395532533844121 = Quaternion.identity; Vector3 leftEdge = Handles.FreeMoveHandle(prevLeftEdge, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
			Handles.color = hasDirection ? Color.red : Color.green;
			var fmh_344_62_638395532533848592 = Quaternion.identity; Vector3 rightEdge = Handles.FreeMoveHandle(prevRightEdge, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
